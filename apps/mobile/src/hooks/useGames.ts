...
const BASE_GAMES: Partial<Record<GameId, Game>> = {
    ...
    [GameId.WheelOfFortune]: {
        ...
        heroImageUrl: `${BASE_URL}assets/images/games/heroes/wof-coming-soon.avif`,
    ...
    [GameId.WitsEnd]: {
        ...
        trackingId: "wits end",
        title: "Wit's End",
        tileImageUrl: `${BASE_URL}assets/images/games/tiles/wits-end.avif`,
        heroImageUrl: `${BASE_URL}assets/images/games/heroes/wits-end.avif`,
...
const validateVideo = async (
    ...
    try {
        ...
        if (error instanceof Error && error.name === "AbortError") {
            logger.info(
                `Video validation aborted for ${url}: ${error.message || "No reason provided"}`
            )
            return false
        }
